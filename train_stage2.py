...
opt = TrainStage2Options().parse()  # set CUDA_VISIBLE_DEVICES before import torch
...
import shutil
# save model
shutil.copyfile('../checkpoints_pub2/contour2shirt/contour2shirt/latest_net_E.pth','./pretrained_models/latest_net_E.pth')
shutil.copyfile('../checkpoints_pub2/contour2shirt/contour2shirt/latest_net_G.pth','./pretrained_models/latest_net_G.pth')
# save train result
