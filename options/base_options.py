...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--encode_size',type=int,default=256,help='size of image that input encoder,support:16,32,64,128,256') #maybe modify
        ...
        self.parser.add_argument('--which_model_netE', type=str, default='resnet_256', help='selects model to use for netE')  #maybe modify
