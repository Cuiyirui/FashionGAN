...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        # lambda parameters
        self.parser.add_argument('--lambda_L1', type=float, default=1.0, help='weight for |B-G(A, E(B))|') #test 10
        ...
        self.parser.add_argument('--use_same_D', type=bool, default=False, help='if two Ds share the weights or not')
        self.isTrain = True
